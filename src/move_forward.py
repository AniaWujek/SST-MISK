...
if len(sys.argv) < 3:
	print("2 args requiered: distance, robot count")
	quit()
	
	#Dystans, jaki mają przebyć   
distance = int(sys.argv[1])  
robot_count = int(sys.argv[2])

for robot_number in range(0,robot_count-1):
	#zasieg radiowy
	max_range = 1
	...
	#końcowe pozycje, ktore maja zajac
	start_positions = []
	y = -current_p[0] + distance
	x = current_p[1]
