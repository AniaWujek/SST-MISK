...
\begin{document}
	...
	\begin{itemize}
		...
		\item \textcolor{red}{Roboty mogą się między sobą komunikować z pewnymi ograniczeniami (odległość, przeszkody).}
		\item Roboty są wyposażone w czujniki pozwalające im wykrywać poziom skażenia oraz przeszkody.
		\item Roboty są wyposażone w urządzenia pozwalające im się między sobą komunikować.
	\end{itemize}
